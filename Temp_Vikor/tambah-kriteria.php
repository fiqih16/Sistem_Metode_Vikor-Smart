...
if(isset($_POST['submit'])):	
	...
	if(empty($errors)):
		...
		$simpan = mysqli_query($koneksi,"INSERT INTO kriteria_v (id_kriteria_v, kode_kriteria_v, nama_v, bobot_v, ada_pilihan_v) VALUES ('', '$kode_kriteria', '$nama', '$bobot', '$ada_pilihan')");
		if($simpan) {
