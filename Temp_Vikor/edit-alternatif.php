...
if(isset($_POST['submit'])):	
	...
	if(empty($errors)):
		...
		$update = mysqli_query($koneksi,"UPDATE alternatif_v SET nama_v = '$nama' WHERE id_alternatif_v = '$id_alternatif'");
		if($update) {
...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="list-alternatif.php" class="btn btn-secondary btn-icon-split"><span class="icon text-white-50"><i
...
<form action="edit-alternatif.php?id=<?php echo $id_alternatif; ?>" method="post">
    <div class="card shadow mb-4">
		...
		$data = mysqli_query($koneksi,"SELECT * FROM alternatif_v WHERE id_alternatif_v='$id_alternatif'");
