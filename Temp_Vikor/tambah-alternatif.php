...
if(isset($_POST['submit'])):	
	...
	if(empty($errors)):
		$simpan = mysqli_query($koneksi,"INSERT INTO alternatif_v (id_alternatif_v, nama_v) VALUES ('', '$nama')");
		if($simpan) {
        ...
        <div class="card-body">
            <div class="row">
                <div class="form-group col-md-12">
                    ...
                    <input autocomplete="off" type="text" name="nama" required value="<?php echo $nama; ?>"
                        class="form-control" />
                </div>
            </div>
        </div>
